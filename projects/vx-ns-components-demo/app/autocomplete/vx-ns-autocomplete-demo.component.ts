...
@Component({
  templateUrl: 'vx-ns-autocomplete-demo.component.html',
  styleUrls: ['vx-ns-autocomplete-demo.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})

export class VxNsAutocompleteDemoComponent implements OnInit {
  states = [
