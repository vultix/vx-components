...
@Component({
  selector: 'vx-autocomplete-demo',
  templateUrl: './autocomplete-demo.component.html',
  styleUrls: ['./autocomplete-demo.component.scss']
})
export class AutocompleteDemoComponent {
  importLbl = `import {VxAutocompleteModule} from 'vx-components';`;

  example1 = `<vx-autocomplete placeholder="Choose A Country" #autocomplete>
  <vx-item *ngFor="let country of countries" [value]="country.value">{{ country.name }}</vx-item>
</vx-autocomplete>
{{ autocomplete.value }}`;
  ...
  constructor(titleService: TitleService) {
    titleService.title = 'Autocomplete';
  }
